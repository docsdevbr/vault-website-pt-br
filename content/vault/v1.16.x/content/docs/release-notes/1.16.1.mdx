...
| 1.16.0+                     | [Reordering of JSON output in audit log](/vault/docs/upgrading/upgrade-to-1.16.x#audit-fields-reorder)                                                             |
...
| New default (1.16.13)       | [Vault product usage metrics reporting](/vault/docs/upgrading/upgrade-to-1.16.x#product-usage-reporting)                                                                                      |
...
| Breaking change (1.16.23+)  | [File audit devices cannot use executable file permissions](/vault/docs/upgrading/upgrade-to-1.16.x#cve-2025-6000)                                                                      |
