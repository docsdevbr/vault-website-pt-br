...
<Warning>
  ...
  **Always** test your audit configuration in a non-production environment
  before deploying filters to production, including the
  [performance impact](/vault/docs/concepts/filtering#performance) of your configured
  filters. And make sure to read the
