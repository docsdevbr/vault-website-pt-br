...
The above steps will wrap the DEK with the latest version of the specified Transit key as the asymmetric KEK.  To use a different version of the Transit key, please specify the version as shown below.
