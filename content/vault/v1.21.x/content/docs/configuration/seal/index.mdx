...
from the environment or a file.  Three URL style forms are supported:
...
* `string://data`: The final value will be everything after string://
  without further interpretation.  This is useful if you needed a literal
  string that was preceded by one of the above special prefixes.
